...
4. CLAUDE.md, AGENTS.md, .claude/settings.json
5. .claude/agents/_common/shared-rules.md
6. .claude/agents/request-intake-agent.md
7. 나머지 agent 파일: implementation_log에 기재된 파일만, 각 50줄 이하로 frontmatter + description 위주 확인
